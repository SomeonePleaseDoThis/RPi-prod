...
docker build --no-cache --tag=$parity_image_name:$parity_version --build-arg PARITY_VERSION=$parity_version --build-arg PARITY_PKG_PATH=$parity_source --build-arg NODE_USER=$USER .
